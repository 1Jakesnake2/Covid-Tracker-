  ...
  <body>
    ...
    <div style="background-color: #1a1a1a;">
      <ul>
        ...
        <li><a href="history" style = "background-color: gray;">Check History</a></li>
        <li><a href="status">Report Positive Case</a></li>
        <li><a href="log_out">Log Out</a></li>
      </ul>
    </div>
    <p><br>
      Your logged activity</p>
      <p>
    ...
    <p>A <b><font color="red">RED</font></b> status indicates you were in
      contact with an individual during that time.</p>
    <footer>
